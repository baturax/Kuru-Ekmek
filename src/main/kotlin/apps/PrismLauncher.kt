...
open class PrismLauncher {
    ...
    private val url = "https://github.com/PrismLauncher/PrismLauncher/releases/download/$version/PrismLauncher-Linux-Qt6-Portable-$version.tar.gz"
    ...
    private val comment = " A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once (Fork of MultiMC) "
    private val runExec = File("$binDirectory/$fileName/PrismLauncher")
    private val icon = File("$binDirectory/$fileName/share/icons/hicolor/scalable/apps/org.prismlauncher.PrismLauncher.svg")
